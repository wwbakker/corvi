 ...
 *
 * The route tables are still typed with Bun's route types (`apps/server/src/capabilities/web.ts`): those are
...
/** The shape `guard` (apps/server/src/capabilities/web.ts) preserves from Bun's route types at compile time;
