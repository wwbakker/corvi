...
/**
 * The live layers behind the capabilities (apps/server/src/integrations/types.ts) — host-side, not part of
 ...
 * rest of the env handling lives (apps/server/src/capabilities/shell.ts). */
