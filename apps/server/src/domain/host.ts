 ...
 * (apps/server/src/app-root/notify.tsx), which is the same entry point a click uses.
 *
 ...
 * page's own top row, the others draw nothing there (apps/server/src/domain/chrome.ts). */
