 ...
 * on screen; the host does the showing (the app's Electron window, apps/server/src/domain/host.ts), because
...
export function Notifier({
  ...
  return (
    <div
      ...
      // same reason as the actions menu's button (apps/server/src/app-root/ActionsMenu.tsx).
